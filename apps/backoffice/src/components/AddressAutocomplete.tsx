...
function GoogleMapsAutocompleteInner({
    ...
    onAddressSelect,
    defaultValue = "",
    placeholder = "Ingresá la dirección del local...",
    className = "",
    ...
    if (loadError) return <div className="text-red-500 text-xs italic">Error en Google Maps API Key</div>;
    if (!isLoaded) return <Input disabled placeholder="Cargando autocompletado..." className={className} />;
